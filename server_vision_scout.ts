...
- DIRECT OCR & LABEL TRUTH: Transcribe printed labels into 'rawNutritionLabel' (preserve exact 0s and % AKG/% DV). Verify negative prefixes across all languages (e.g. 'un-'/'non-'/'tidak': never mistake unsaturated for saturated fat, or insoluble for soluble fiber). When packaging/label accompanies prepared food across photos, anchor the dish's nutrients to the printed label truth.
