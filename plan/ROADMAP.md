...
1. **Q-4 DONE** — q-4a→q-4b→q-4c→q-4d COMPLETE (`specs/done/`), ART 2975→1501, ceiling 1800, on `journey/q-4-thin` (pushed, pending merge). Parent packet `superseded`.
2. **Q-10 COMPLETE** — `specs/done/q-10-dependency-audit.md`, removals only, on `journey/q-10-dependency-audit` (pending merge).
