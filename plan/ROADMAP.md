...
**Next code is BOT-14.** Load [docs/agents/bot_work.md](../docs/agents/bot_work.md) and stop. Do not load the bot table below for execution. BOT-23 is DONE. BOT-21 is DONE.
