...
who: any-agent
auto_go: false
blocked_human: 'R-13.1 host retargeted to OVH VPS-2 (plan/VPS2_MOBILE_DEV.md Track V). Do not start until V-0 (VPS purchased). Do not deploy Cloud Run or Cloudflare Containers.'
allowed_files:
  - package.json
  - server.ts
  - Dockerfile
...
**R-13.1 is `blocked_human` (2026-09-19).** Origin is **OVH VPS-2**, not Cloudflare Containers and not Cloud Run. Follow [plan/VPS2_MOBILE_DEV.md](../../plan/VPS2_MOBILE_DEV.md) Track V: dev box and mobile agents first (V-0…V-12), then site cutover (V-13…V-16). Do not start R-13.1 in the same tree as F-13. Do not start R-13.4 / R-5 / a Cloud Run go-live.
