...
export function canMergeScoutLabelIntoFood(labelItem: any, foodItem: any): any {
  if (!labelItem || !foodItem) return { ok: false, score: 0 };
  return { ok: true, score: 1 };
}

export function mergeScoutItems(...args: any[]): any[] {
