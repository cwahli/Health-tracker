...
export const biomarkerDefinitions: BiomarkerDefinition[] = [
  ...
  },
  {
    ...
    normalRange: '3.5 - 5.0',
    descriptions: {
      en: 'Essential electrolyte regulating cardiac rhythm, neuromuscular transmission, and cellular fluid balance.',
      fr: 'Potassium sérique, électrolyte essentiel régulant le rythme cardiaque et la fonction neuromusculaire.',
      zh: '血清钾：调节心脏节律、神经肌肉兴奋性和体液平衡的关键电解质。',
      id: 'Kalium serum: elektrolit esensial pengatur ritme jantung dan transmisi neuromuskular.'
    },
    riskCategories: ['Renal', 'Cardiovascular'],
    standardMedicalGrouping: 'Renal / Electrolytes',
    aliases: ['potassium', 'serum_potassium_mmol_l', 'serumpotassium', 'k_serum']
  },
  {
    key: 'serum_sodium',
    name: 'Serum Sodium',
    ...
    normalRange: '135 - 145',
    descriptions: {
      en: 'Primary extracellular electrolyte regulating osmotic pressure, blood volume, and membrane potential.',
      fr: 'Sodium sérique, principal électrolyte extracellulaire régulant la volémie et la pression osmotique.',
      zh: '血清钠：维持细胞外液渗透压、循环血容量和细胞膜电位的主要阳离子。',
      id: 'Natrium serum: elektrolit ekstraseluler utama pengatur tekanan osmotik dan volume darah.'
    },
    riskCategories: ['Renal', 'Cardiovascular'],
    standardMedicalGrouping: 'Renal / Electrolytes',
    aliases: ['sodium', 'serum_sodium_mmol_l', 'serumsodium', 'na_serum']
  },
  {
    key: 'total_bilirubin',
    ...
    normalRange: '3 - 21',
    descriptions: {
      en: 'Bile pigment derived from erythrocyte breakdown; evaluated for hepatobiliary clearance and hemolysis.',
      fr: 'Bilirubine totale, pigment biliaire issu de la dégradation des globules rouges reflétant la fonction hépatobiliaire.',
      zh: '总胆红素：红细胞衰老降解产生的胆汁色素，用于评估肝胆代谢与溶血状态。',
      id: 'Bilirubin total: pigmen empedu hasil pemecahan eritrosit untuk evaluasi fungsi hepatobilier.'
    },
    riskCategories: ['Hepatic'],
    standardMedicalGrouping: 'Hepatic / Liver',
    aliases: ['bilirubin', 'serum_total_bilirubin', 'serumbilirubin', 'total_bilirubin_umol_l']
  },
  {
    ...
    normalRange: '< 2.5',
    descriptions: {
      en: 'Glycoprotein enzyme produced by prostatic epithelium; utilized for prostate health screening.',
      fr: 'Antigène prostatique spécifique (PSA), marqueur de dépistage de la santé prostatique.',
      zh: '前列腺特异性抗原（PSA）：前列腺上皮细胞分泌的糖蛋白，用于前列腺健康筛查。',
      id: 'Antigen spesifik prostat (PSA) untuk penapisan kesehatan prostat.'
    },
    riskCategories: ['Screenings & Wellness'],
    standardMedicalGrouping: 'Screenings & Wellness',
    aliases: ['psa', 'total_psa', 'serum_psa', 'prostate_specific_antigen_total']
  },
  {
    key: 'serum_adjusted_calcium',
    name: 'Serum Adjusted Calcium',
    category: 'other',
    unit: 'mmol/L',
    normalRange: '2.20 - 2.60',
    descriptions: {
      en: 'Serum calcium adjusted for serum albumin concentration, reflecting physiological ionized calcium.',
      fr: 'Calcium sérique corrigé de l albumine, reflétant la fraction biologiquement active.',
      zh: '校正血清钙：结合血清白蛋白水平校准后的钙离子浓度，反映生理活性钙水平。',
      id: 'Kalsium serum terkoreksi albumin yang mencerminkan fraksi kalsium aktif.'
    },
    riskCategories: ['Bone & Mineral'],
    standardMedicalGrouping: 'Bone & Mineral / Electrolytes',
    aliases: ['adjusted_calcium', 'corrected_calcium', 'serum_adjusted_calcium_mmol_l']
  },
  {
    key: 'serum_calcium',
    name: 'Serum Calcium',
    ...
    descriptions: {
      en: 'Total serum calcium essential for mineralized bone matrix, cardiac excitation, and cell signaling.',
      fr: 'Calcium sérique total essentiel à la minéralisation osseuse et à la conduction cardiaque.',
      zh: '血清总钙：骨骼矿化、心脏电生理及细胞信号传导必需的关键阳离子。',
      id: 'Kalsium serum total untuk kepadatan tulang dan konduksi saraf-otot.'
    },
    riskCategories: ['Bone & Mineral'],
    standardMedicalGrouping: 'Bone & Mineral / Electrolytes',
    aliases: ['calcium', 'total_calcium', 'serum_calcium_mmol_l']
  },
  {
    ...
    normalRange: '30 - 130',
    descriptions: {
      en: 'Hydrolase enzyme abundant in biliary canaliculi and osteoblasts; screens for cholestasis and bone turnover.',
      fr: 'Phosphatase alcaline, enzyme présente dans les voies biliaires et les os.',
      zh: '碱性磷酸酶（ALP）：分布于胆管上皮与成骨细胞的同工酶，用于胆汁淤积和骨转换监测。',
      id: 'Fosfatase alkali (ALP): enzim penanda kolestasis empedu dan perombakan tulang.'
    },
    riskCategories: ['Hepatic', 'Bone & Mineral'],
    standardMedicalGrouping: 'Hepatic / Liver',
    aliases: ['alp', 'serum_alkaline_phosphatase', 'alk_phos', 'alkaline_phosphatase_u_l']
  },
  {
    key: 'serum_inorganic_phosphate',
    name: 'Serum Inorganic Phosphate',
    category: 'other',
    unit: 'mmol/L',
    normalRange: '0.80 - 1.50',
    descriptions: {
      en: 'Inorganic phosphate crucial for ATP bioenergetics, acid-base homeostasis, and hydroxyapatite bone crystal formation.',
      fr: 'Phosphate inorganique sérique, impliqué dans le métabolisme énergétique et la minéralisation osseuse.',
      zh: '血清无机磷：能量代谢（ATP合成）、酸碱平衡维持与骨矿化的重要阴离子。',
      id: 'Fosfat anorganik serum untuk bioenergetika seluler dan mineralisasi tulang.'
    },
    riskCategories: ['Bone & Mineral', 'Renal'],
    standardMedicalGrouping: 'Bone & Mineral / Electrolytes',
    aliases: ['phosphate', 'inorganic_phosphate', 'serum_phosphate', 'serum_inorganic_phosphate_mmol_l']
  },
  {
    key: 'serum_globulin',
    name: 'Serum Globulin',
    ...
    normalRange: '20 - 35',
    descriptions: {
      en: 'Serum proteins excluding albumin, comprising immunoglobulins, complement factors, and transport globulins.',
      fr: 'Globulines sériques incluant les immunoglobulines et protéines de transport.',
      zh: '血清球蛋白：血清中除白蛋白外的蛋白质总和，包含免疫球蛋白、补体及转运蛋白。',
      id: 'Globulin serum: fraksi protein selain albumin yang mencakup antibodi dan protein transport.'
    },
    riskCategories: ['Hepatic', 'Immune'],
    standardMedicalGrouping: 'Hepatic / Proteins',
    aliases: ['globulin', 'serum_globulin_g_l', 'total_globulin']
  },
  {
    ...
    normalRange: '< 3.8',
    descriptions: {
      en: 'Total cholesterol minus HDL-C; quantifies circulating atherogenic apolipoprotein B-containing particles.',
      fr: 'Cholestérol non-HDL, mesurant la totalité des lipoprotéines athérogènes circulantes.',
      zh: '非高密度脂蛋白胆固醇（Non-HDL-C）：总胆固醇减去HDL-C，反映所有致动脉粥样硬化颗粒总量。',
      id: 'Kolesterol non-HDL: total kolesterol dikurangi HDL-C yang mengukur partikel aterogenik.'
    },
    riskCategories: ['Cardiovascular', 'Metabolic'],
    standardMedicalGrouping: 'Cardiovascular / Lipids',
    aliases: ['non_hdl', 'non_hdl_c', 'se_non_hdl_cholesterol', 'non_hdl_cholesterol_mmol_l']
  },
  {
    ...
    normalRange: '< 4.0',
    descriptions: {
      en: 'Ratio of total serum cholesterol to cardioprotective HDL cholesterol, serving as an atherogenic risk index.',
      fr: 'Ratio cholestérol total sur HDL, indicateur d équilibre athérogène.',
      zh: '总胆固醇/高密度脂蛋白比值：评估心血管动脉粥样硬化倾向的综合比率。',
      id: 'Rasio kolesterol total terhadap HDL sebagai indeks risiko aterogenik.'
    },
    riskCategories: ['Cardiovascular'],
    standardMedicalGrouping: 'Cardiovascular / Lipids',
    aliases: ['chol_hdl_ratio', 'cholesterol_to_hdl_ratio', 'total_cholesterol_hdl_ratio', 'serum_cholesterol_hdl_ratio']
  },
  {
    key: 'platelet_distribution_width',
    name: 'Platelet Distribution Width',
    category: 'hematology',
    unit: 'fL',
    normalRange: '8.3 - 18.0',
    descriptions: {
      en: 'Geometric standard deviation of platelet size distribution; reflects thrombopoiesis and platelet activation.',
      fr: 'Indice de distribution plaquettaire (PDW), reflétant la variabilité volumétrique des plaquettes.',
      zh: '血小板分布宽度（PDW）：反映循环血小板体积大小均一性的参数，指示骨髓巨核细胞产板状态。',
      id: 'Lebar distribusi trombosit (PDW): variasi ukuran trombosit dalam darah tepi.'
    },
    riskCategories: ['Hematology'],
    standardMedicalGrouping: 'Hematology',
    aliases: ['pdw', 'platelet_distribution_width_fl']
  },
  {
    key: 'nucleated_red_blood_cell_count',
    name: 'Nucleated Red Blood Cell Count',
    category: 'hematology',
    unit: '10^9/L',
    normalRange: '0.00 - 0.01',
    descriptions: {
      en: 'Immature nucleated erythrocytes in peripheral circulation; normally negligible in healthy adult blood.',
      fr: 'Érythroblastes circulants (NRBC), normalement absents ou minimes chez l adulte sain.',
      zh: '有核红细胞计数（NRBC）：外周血中未成熟有核幼红细胞，健康成人通常为零或极微量。',
      id: 'Hitung eritrosit berinti (NRBC): sel darah merah muda yang normalnya sangat minimal pada dewasa sehat.'
    },
    riskCategories: ['Hematology'],
    standardMedicalGrouping: 'Hematology',
    aliases: ['nrbc', 'nucleated_rbc', 'nucleated_red_blood_cells']
  }
];
