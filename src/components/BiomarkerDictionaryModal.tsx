...
import DictionaryConsolidationPanel from './DictionaryConsolidationPanel';
import DictionaryDataAccuracyPanel from './DictionaryDataAccuracyPanel';
import DictionaryAgentPanel from './DictionaryAgentPanel';
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-0">
      <div className="bg-theme-bg-card w-full h-full flex flex-col overflow-hidden">
        ...
        {isDataAccuracyMode ? (
          <DictionaryDataAccuracyPanel
            profile={profile}
            showResetChatConfirm={showResetChatConfirm}
            setShowResetChatConfirm={setShowResetChatConfirm}
            showDiscardResultsConfirm={showDiscardResultsConfirm}
            setShowDiscardResultsConfirm={setShowDiscardResultsConfirm}
            dataAccuracyMessages={dataAccuracyMessages}
            setDataAccuracyMessages={setDataAccuracyMessages}
            setDataAccuracyInput={setDataAccuracyInput}
            dataAccuracyInput={dataAccuracyInput}
            dataAccuracyLoading={dataAccuracyLoading}
            setAccuracyUploadedFiles={setAccuracyUploadedFiles}
            accuracyUploadedFiles={accuracyUploadedFiles}
            accuracyComparisonResults={accuracyComparisonResults}
            setAccuracyComparisonResults={setAccuracyComparisonResults}
            setAccuracySelectedFields={setAccuracySelectedFields}
            accuracySelectedFields={accuracySelectedFields}
            fileInputRef2={fileInputRef2}
            dataAccuracyModel={dataAccuracyModel}
            setDataAccuracyModel={setDataAccuracyModel}
            setShowDataAccuracyInstructions={setShowDataAccuracyInstructions}
            selectedKeys={selectedKeys}
            handleAccuracyFileSelect={handleAccuracyFileSelect}
            removeAccuracyFile={removeAccuracyFile}
            handleSendDataAccuracy={handleSendDataAccuracy}
            applySelectedAccuracyUpdates={applySelectedAccuracyUpdates}
            accuracyChatEndRef={accuracyChatEndRef}
          />
        ) : isNameConsolidationMode ? (
          <DictionaryConsolidationPanel
            profile={profile}
            biomarkerHistory={biomarkerHistory}
            nameConsolidationModel={nameConsolidationModel}
            setNameConsolidationModel={setNameConsolidationModel}
            setShowConsolidationInstructions={setShowConsolidationInstructions}
            consolidationYaml={consolidationYaml}
            consolidationGroups={consolidationGroups}
            consolidationLoading={consolidationLoading}
            consolidationLiveThought={consolidationLiveThought}
            consolidationInput={consolidationInput}
            setConsolidationInput={setConsolidationInput}
            consolidationMessages={consolidationMessages}
            setConsolidationMessages={setConsolidationMessages}
            groupEdits={groupEdits}
            setGroupEdits={setGroupEdits}
            setShowOnlyReduced={setShowOnlyReduced}
            showOnlyReduced={showOnlyReduced}
            reducedGroupsCount={reducedGroupsCount}
            totalOriginalBiomarkersInConsolidation={totalOriginalBiomarkersInConsolidation}
            totalMasterBiomarkersInConsolidation={totalMasterBiomarkersInConsolidation}
            totalBiomarkersReduced={totalBiomarkersReduced}
            selectedKeys={selectedKeys}
            editingGroupIdx={editingGroupIdx}
            setEditingGroupIdx={setEditingGroupIdx}
            setViewingLogsKey={setViewingLogsKey}
            handleRunConsolidationAgent={handleRunConsolidationAgent}
            handleApplyConsolidation={handleApplyConsolidation}
          />
        ) : isChatMode ? (
          ...
          <DictionaryAgentPanel
            profile={profile}
            isMedicalCategorisationMode={isMedicalCategorisationMode}
            isRangeCalibrationMode={isRangeCalibrationMode}
            selectedLogFixKeys={selectedLogFixKeys}
            setSelectedLogFixKeys={setSelectedLogFixKeys}
            standardizeModel={standardizeModel}
            medicalCategoriseModel={medicalCategoriseModel}
            calibrateRangesModel={calibrateRangesModel}
            setStandardizeModel={setStandardizeModel}
            setMedicalCategoriseModel={setMedicalCategoriseModel}
            setCalibrateRangesModel={setCalibrateRangesModel}
            setShowStandardizeInstructions={setShowStandardizeInstructions}
            setShowMedicalInstructions={setShowMedicalInstructions}
            setShowCalibrateInstructions={setShowCalibrateInstructions}
            setTargetMetric={setTargetMetric}
            targetMetric={targetMetric}
            agentLoading={agentLoading}
            standardizationYaml={standardizationYaml}
            setStandardizationYaml={setStandardizationYaml}
            standardizationSummary={standardizationSummary}
            setStandardizationSummary={setStandardizationSummary}
            selectedKeys={selectedKeys}
            handleToggleSelect={handleToggleSelect}
            handleRunStandardizationAgent={handleRunStandardizationAgent}
            handleApplyStandardization={handleApplyStandardization}
          />
        ) : isBatchPasteMode ? (
