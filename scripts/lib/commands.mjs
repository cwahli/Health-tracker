...
export const BOT_COMMANDS = [
  ...
  { command: 'web', description: 'Open the opencode web terminal (Mini App)' },
  { command: 'tui', description: 'Open the opencode TUI in a real terminal (Mini App)' },
...
export function helpText(config, { model, agent, variant } = {}) {
  return [
    ...
    '/web             open the opencode web terminal (Mini App button)',
    '/tui             open the opencode TUI in a real terminal (Mini App button)',
