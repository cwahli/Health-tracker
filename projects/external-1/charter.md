# Project Charter: External-1 — Performance Rating & PIP Defense Council
...
- **Isolated Workspace**: All project activities occur strictly within this project's workspace and its connected Google Drive folder `[External-1-PIP-Defense]`.
